...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-[#FF9B9B] to-[#FFB5B5]">
      ...
      {/* Content */}
      <div className="relative z-10 min-h-screen px-6 pt-12 sm:pt-16 sm:px-8">
        <div className="max-w-md mx-auto w-full">
          <div className="mb-6 sm:mb-8">
            <h1 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">Daftar</h1>
          ...
          <div className="space-y-4 sm:space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <Phone className="absolute left-0 top-1/2 -translate-y-1/2 w-4 h-4 sm:w-5 sm:h-5 text-gray-400" />
                <Input
                  type="tel"
            ...
            <Button
              className="w-full bg-primary hover:bg-primary/90 text-white rounded-xl sm:rounded-2xl py-5 sm:py-6 text-base sm:text-lg font-medium shadow-lg mt-10 sm:mt-12"
            >
              Create Account
            </Button>

            {/* Login Link */}
            <p className="text-center text-sm sm:text-base text-gray-600 pt-3 sm:pt-4">
              Sudah punya akun?{" "}
              <button
